...
const ROLE_HIERARCHY = {
  ...
  manager: 2,    // Can create, edit, view, delete, approve
...
// Helper function to check if user can delete resources (Admin only)
...
const checkResourceAccess = (resourceUserId) => {
  return (req, res, next) => {
    ...
    const hasAdminAccess = isAdmin(userRole) || isManager(userRole);
