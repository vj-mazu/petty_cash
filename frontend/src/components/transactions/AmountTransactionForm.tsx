    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="flex items-center space-x-3">
                  <div className={`p-2 rounded-full ${
                    watchedType === 'credit' ? 'bg-emerald-500 text-white' : 'bg-gray-200 text-gray-600'
                  }`}>
                    <TrendingUp className="w-5 h-5" />
                  </div>
                  <div>
                    <div className={`font-medium ${
                      watchedType === 'credit' ? 'text-emerald-900' : 'text-gray-700'
                    }`}>
                      Credit (+)
                    </div>
                    <div className={`text-sm ${
                      watchedType === 'credit' ? 'text-emerald-600' : 'text-gray-500'
                    }`}>
                      Money coming in
                    </div>
                  </div>
              ...
              >
                ...
                <div className="flex items-center space-x-3">
                  <div className={`p-2 rounded-full ${
                    watchedType === 'debit' ? 'bg-red-500 text-white' : 'bg-gray-200 text-gray-600'
                  }`}>
                    <TrendingDown className="w-5 h-5" />
                  </div>
                  <div>
                    <div className={`font-medium ${
                      watchedType === 'debit' ? 'text-red-900' : 'text-gray-700'
                    }`}>
                      Debit (-)
                    </div>
                    <div className={`text-sm ${
                      watchedType === 'debit' ? 'text-red-600' : 'text-gray-500'
                    }`}>
                      Money going out
                    </div>
                  </div>
          ...
          {/* Ledger Selection */}
          <div>
            <label htmlFor="ledgerId" className="block text-sm font-medium text-gray-700 mb-2">
              Select Ledger *
            </label>
            <div className="relative">
              <select
                ...
                className={`input-field pl-10 pr-8 appearance-none bg-white ${
                  errors.ledgerId ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                }`}
              >
            ...
            {selectedLedger && (
              <div className="mt-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                <div className="flex justify-between items-center">
                  <div>
                    <div className="text-sm font-medium text-blue-900">{selectedLedger.name}</div>
          ...
          <div>
            ...
            <input
              ...
              type="text"
              className={`input-field ${
                errors.reference ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
              }`}
