    ...
    <div className="space-y-6 p-4">
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label htmlFor="ledger" className="block text-sm font-medium text-gray-700 mb-1">
              Ledger
            </label>
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-8 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 appearance-none bg-white"
        ...
        <div className="flex justify-between mt-4">
          <button
            ...
            className="flex items-center px-4 py-2 bg-gray-200 text-gray-800 rounded-lg font-medium hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200"
          >
