  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      ...
      <div className="flex items-center space-x-3">
        ...
        <h1 className="text-xl font-bold text-gray-900">Create New Ledger</h1>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit as any)} className="space-y-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                id="name"
                type="text"
                className={`block w-full px-3 py-1.5 text-sm rounded-lg border shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-200 transition-all duration-200 ${errors.name ? 'border-red-500 focus:border-red-500 focus:ring-red-200' : 'border-gray-300'
                  }`}
                {...register('name')}
            ...
            <div>
              ...
              <textarea
                id="description"
                rows={2}
                className={`block w-full px-3 py-1.5 text-sm rounded-lg border shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-200 transition-all duration-200 resize-none ${errors.description ? 'border-red-500 focus:border-red-500 focus:ring-red-200' : 'border-gray-300'
                  }`}
          ...
          <div className="flex items-center justify-end pt-4 border-t border-gray-100 space-x-3">
            <button
              type="button"
              onClick={() => navigate('/ledgers')}
              className="px-4 py-1.5 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200 transition-all duration-200"
            >
              Cancel
            </button>
            <motion.button
              ...
              className="px-5 py-1.5 text-sm font-semibold text-white bg-primary-600 rounded-lg hover:bg-primary-700 focus:ring-2 focus:ring-primary-200 transition-all duration-200 flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
