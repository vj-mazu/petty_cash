...
import { Save, DollarSign, TrendingUp, AlertCircle, History, Shield } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {!hasOpeningBalanceAccess ? (
        <motion.div
          ...
          className="card p-8 text-center bg-red-50 border-red-200"
        >
          <div className="flex flex-col items-center space-y-4">
            ...
            <div>
              ...
              <p className="text-red-800 max-w-md mx-auto">
                Opening Balance settings can only be accessed by Admin users.
              </p>
            </div>
        ...
        <>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Global Opening Balance</h1>
              <p className="text-gray-600 mt-1">Set the one-time global opening balance for your entire cash management system</p>
            </div>
          </div>
          ...
          >
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800">This is the global opening balance for your system. All calculations are based on this value.</p>
              </div>
            </div>
          </motion.div>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${isSet ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                    }`}>
                    {isSet ? '✅ Set' : '⚠️ Not Set'}
                  </div>
                </div>
                ...
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm font-medium text-gray-600 mb-2">Current Opening Balance</p>
