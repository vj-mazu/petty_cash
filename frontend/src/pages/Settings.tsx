    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
          ...
          className="card p-6 bg-gradient-to-br from-blue-50 to-indigo-100 border-blue-200"
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800 capitalize mt-1">
            ...
            <div className="bg-white bg-opacity-50 rounded-lg p-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-blue-800">{user?.isActive ? '✅ Active' : '❌ Inactive'}</p>
                </div>
                <div>
                  <span className="text-blue-600 font-medium">Last Login:</span>
        ...
        <motion.div
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
          className="card p-6 bg-gradient-to-br from-green-50 to-emerald-100 border-green-200"
        >
      ...
      <motion.div
        ...
        className="card p-6 bg-gradient-to-br from-purple-50 to-violet-100 border-purple-200"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white bg-opacity-60 rounded-lg p-4">
            <h4 className="font-semibold text-purple-800 mb-2">💰 Currency</h4>
            <div className="space-y-1 text-sm text-purple-700">
      ...
      <motion.div
        ...
        className="card p-6 bg-gradient-to-br from-yellow-50 to-orange-100 border-yellow-200"
      >
