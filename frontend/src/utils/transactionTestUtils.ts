...
export const logTransactionOperation = (operation: 'edit' | 'delete', transactionId: string, data?: any, result?: any, error?: any) => {
  ...
  try {
    ...
    console.warn('Could not save operation log to localStorage:', e);
  }
};
...
export const getTransactionOperationLogs = () => {
  try {
    ...
    console.warn('Could not retrieve operation logs from localStorage:', e);
    return [];
  }
};
...
export const clearTransactionOperationLogs = () => {
  try {
    ...
    console.log('Transaction operation logs cleared');
  } catch (e) {
    console.warn('Could not clear operation logs:', e);
  }
};